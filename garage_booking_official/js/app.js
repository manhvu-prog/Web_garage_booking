// =====================================================
// app.js – Dữ liệu mẫu & hàm tiện ích dùng chung
// Dùng cho tất cả các trang: index, staff, admin
// =====================================================

// -------------------------------------------------------
// DỮ LIỆU MẪU (Mock Data)
// Mô phỏng dữ liệu từ database garage_booking1
// -------------------------------------------------------
const AppData = {
...
// Định dạng giờ từ backend: chấp nhận số giây (timedelta MySQL) hoặc chuỗi "HH:MM(:SS)"
function formatTime(val) {
  if (val == null || val === '') return '–';
  if (typeof val === 'string') return val.slice(0, 5);   // "08:00:00" → "08:00"
...
// Chuỗi tìm kiếm: bỏ dấu tiếng Việt + chữ thường (khớp với backend search_norm)
...
// Hiển thị thông báo toast góc trên phải (mặc định ~6 giây; có thể truyền durationMs)
function showToast(msg, type = 'success', durationMs = 6000) {
